...
import por from "../../images/portfo.gif";
...
import clr from "../../images/clr.gif";
import vision from "../../images/vision.gif";
import chs from "../../images/chs.gif";
import att from "../../images/att.gif";
              ...
              <Container fluid className="certificate-section" id="about">
                <Container>
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/PKulal/P-Host"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/PKulal/python_projects_grocery_webapp"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/PKulal/Snake_game"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/PKulal/Vision-Response"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/PKulal/Color_Game"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/PKulal/Chess_Game"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/PKulal/Gender-and-Age-Prediction"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                              ...
                              <h6>
                                ...
                                >
                                  Its an ML based application which tells Gender and Age of a Person
                                </p>
                              </h6>
                              <div
                                className="project--lang"
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/PKulal/Attendance-System"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                              ...
                              <h6>
                                ...
                                >
                                  This project involves building an attendance system which utilizes facial recognition to mark the presence, time-in, and time-out of employees. It covers areas such as facial detection, alignment, and recognition, along with the development of a web application .
                                </p>
                              </h6>
                              <div
                                className="project--lang"
                  ...
                  <div className="blog--viewAll">
                    <a href="https://github.com/PKulal" target="_blank" rel="noopener noreferrer">
